...
export function SiteFooter() {
  return (
    <footer className="relative overflow-hidden bg-crowd-brown py-14 text-crowd-cream md:py-20">
      <LuminousInfinity
        variant="footer"
        className="absolute -right-64 top-5 h-72 w-[44rem] rotate-[11deg] opacity-28 md:-right-80 md:h-[28rem] md:w-[62rem]"
      />
      <LuminousInfinity
        variant="streak"
        sparkles={false}
        className="absolute bottom-8 right-10 hidden h-24 w-72 -rotate-[4deg] opacity-32 md:block"
      />
