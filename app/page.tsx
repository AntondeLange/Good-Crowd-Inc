...
export default function HomePage() {
  return <>
    ...
    <section className="py-24"><div className="container-crowd grid gap-10 md:grid-cols-2"><h2 className="display text-5xl md:text-7xl">Every community has a good crowd.</h2><div><p className="text-xl leading-8">We started Good Crowd Inc. because we couldn&rsquo;t wait any longer for the world to discover what regional Australia already knows — that the best communities, the most extraordinary stories, and the warmest welcomes are found beyond the city limits.</p><Link href="/about" className="mt-8 inline-block font-bold underline">Read Our Story →</Link></div></div></section>
